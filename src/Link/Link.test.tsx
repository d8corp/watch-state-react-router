...
import {Link, history} from '../index'
...
describe('Link', () => {
  ...
  test('external link', () => {
    const link = shallow(<Link href='https://github.com/d8corp/watch-state-react-router'>test</Link>)

    expect(link.html()).toBe('<a href="https://github.com/d8corp/watch-state-react-router" rel="noopener noreferrer nofollow" target="_blank">test</a>')
  })
  test('locale link', () => {
