...
import watch, { unwatch, Watch, stateValues, WATCHER, state, cache, mixer, event } from '@watch-state/react';
...
let Router = class Router extends Component {
    ...
    componentWillUnmount() {
        ...
        (_a = this.reaction) === null || _a === void 0 ? void 0 : _a.destructor();
    }
    get children() {
        const { matchReg } = this;
        if (!matchReg)
    ...
    onShow() {
        ...
        if (!this.show && !this.props.other && this.context) {
            ...
            if (!childRouters.size) {
                ...
                stateValues(this.context).childRouters.update();
            }
            else {
                childRouters.add(this);
            }
